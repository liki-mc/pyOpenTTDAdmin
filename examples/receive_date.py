from pyopenttdadmin import Admin, AdminUpdateType, AdminUpdateFrequency, openttdpacket as p, Auth
...
# Print date packets
@admin.add_handler(p.DatePacket)
def date_packet(admin: Admin, packet: p.DatePacket):
    print(packet)
